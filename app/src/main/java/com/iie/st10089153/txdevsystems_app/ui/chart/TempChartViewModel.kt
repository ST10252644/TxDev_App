...
class TempChartViewModel(private val repo: ChartsRepository = ChartsRepository()) : ViewModel() {
    private val _ui = MutableStateFlow(TempUi())
    val ui: StateFlow<TempUi> = _ui
