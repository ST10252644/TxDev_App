...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.8.1")  // ← ADD THIS
    ...
    // ========== FIREBASE - THESE LINES ARE IMPORTANT! ==========
...
// ← ADD THIS LINE AT THE END - VERY IMPORTANT!
